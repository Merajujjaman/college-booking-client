    ...
    return (
        <div className='flex'>
            ...
            <Carousel autoPlay={true} infiniteLoop={true} showStatus={false} stopOnHover={false} showThumbs={false}>
                ...
                <div>
                    <img className='' src="https://www.keele.ac.uk/graduation/news/keele-celebrates/Im1S.jpg" />
                    
                </div>
                <div>
                    <img className='' src="https://www.trailtimes.ca/wp-content/uploads/2020/03/21132533_web1_200331-SNE-UniGradCeremonies-grad_1.jpg" />
